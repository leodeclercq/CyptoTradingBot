...
# Seuils
bearish_slope_threshold = -4  # seuil pour détecter une pente baissière forte
bullish_slope_threshold = 28  # seuil pour détecter une pente haussière forte
...
def backtest():
    ...
    for i in range(151, len(initial_data)):  # Commencer après les 150 premières bougies
        ...
        if len(tema20_window) > 2:
            ...
            if  last_buy_price < initial_data[i] * 1.00075 and current_position == "buy"  and tema20 > tema50 and tema20 <= last_tema * 1.0003 and last_data <= last_datas * 1.0008 and btc_balance >= 0.0001: #last_buy_price < initial_data[i] * 1.00075
            ...
            if current_position == "none" and tema20 < tema50 and tema20 >= last_tema * 1.0003 and last_data >= last_datas * 1.0008 and usdt_balance >= 10.00: # and initial_data[i] <= 96500.0:
