...
def livetest():
    ...
    while True:
        try:
            ...
            if current_position == "buy" and btc_balance >= 0.0001 and closed_price  >= last_buy_price* 1.00075  and tema20 > tema50 and tema20 <= tema20_window[-1] * 1.00028 and closed_price <= data_window[-1] * 1.0008:
            ...
            if current_position == "none" and tema20 < tema50 and usdt_balance >= 10.00 and tema20 >= tema20_window[-1] * 1.00028 and closed_price >= data_window[-1] * 1.0008:
