...
def livetest():
    ...
    while True:
        try:
            ...
            next_candle_time = (current_time // 3600 + 1) * 3600  # Prochain multiple de 900s (15min)
            ...
            if len(data_window) >= 150:
                ...
                if len(tema20_window) >= 3:
                    ...
                    if current_position == "buy" and btc_balance >= 0.0001 and closed_price * 1.00075 >= last_buy_price  and tema20 > tema50 and tema20 <= tema20_window[-1] * 1.001 and closed_price <= data_window[-1] * 1.005:
                    ...
                    if current_position == "none" and tema20 < tema50 and usdt_balance >= 10.00 and tema20 >= tema20_window[-1] * 1.001 and closed_price >= data_window[-1] * 1.005:
