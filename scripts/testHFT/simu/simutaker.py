    ...
    if 'c' in msg:
        ...
        if len(data_window) >= 151:
            ...
            if len(tema_window) >= 61:
                ...
                if current_position == "buy" and tema20 <= recent_max * 0.9999999 and btc_balance >= 0.0001 and price >= last_buy_price * 1.0015: #and price >= last_buy_price * 1.001
                    if slope is not None and slope < bearish_slope_threshold and tema20 > (tema50 - 0.4):
                        usdt_balance += (btc_balance * 0.99925)   * price  # Conversion de BTC en USDT
